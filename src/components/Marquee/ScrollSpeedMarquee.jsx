...
export const ScrollSpeedMarquee = ({
  children,
  duration,
  direction,
  scrollSpeedBased,
  ...
  return (
    <div className="flex origin-left overflow-hidden">
      <div className={`marquee__inner flex ${elementSpacing}`} ref={ref}>
        <div
          className={`marquee__part relative flex flex-shrink-0 items-center whitespace-nowrap ${elementSpacing}`}
        >
          {children}
          {children}
        </div>
