...
const MobileAppDevelopmentCompany = ({ data }) => {
    return (
                        ...
                        {[
                            {
                                ...
                                description:
                                    'Mariox is one of the best Android app development companies in ' + data.cityName + ' , offering fully functional and secure application solutions tailored to business needs. Our company has an ample understanding of frameworks, industry experience, technical knowledge and innovative approaches.	',
                            },
                            {
                            ...
                            },
                            {
                                ...
                                description:
                                    'Hybrid application development in ' + data.cityName + ' involves creating an app compatible with numerous platforms. It uses a framework that works on iOS, Android, and Windows platforms. Hybrid application development uses web technologies such as CSS, JavaScript and HTML.',
                            },
                            {
                                serviceIcon: '/img/wearable-app-dev.svg',
                                heading: 'E-Commerce App Development',
                                description:
                                    'Being an end-to-end e-commerce app development company in ' + data.cityName + ' ,we use advanced technologies to unlock potential revenue streams for you while maximising the business prospects of their application or product.',
                            },
                            {
                ...
                <div className="container">
                    <div className=" mb-12">
                        ...
                        <p className="text-16 leading-[120%] max-w-[715px]">
                            ...
                            development company in {data.cityName} with expertise in developing and
                            ...
                            venture.<br></br>
                            <br></br>
                            We are a top-rated mobile app development company in {data.cityName}.
                            You can rely on Mariox’s talented team of developers to
