...
const WebsiteDevelopmentCompany = ({ data }) => {
  return (
            ...
            <div className="w-full md:w-5/12 px-3">
              <div className=" sticky top-15">
                ...
                <p className="lg:max-w-[90%]">
                  ...
                  globally and in {data.cityName} for offering client-centric website development
            ...
            {[
              {
                ...
                description: (
                  <>
                    ...
                    applications right from consulting,
                    maintenance, development, and support.
                    Our skilled developers have the technical
                    expertise to deliver complex and multi-disciplinary projects
                  </>
                ),
              },
              {
                ...
                description: (
                  <>
                    As a leading website development company in {data.cityName}, Our back-end development professionals
                    build complex server-side layers, enable cloud integration,
                    and facilitate smart digital transformation strategies to strengthen your core IT landscape.
                    The dedicated team will deliver value and quality products.
                  </>
                ),
              },
              {
...
export default WebsiteDevelopmentCompany;
