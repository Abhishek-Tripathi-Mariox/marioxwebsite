...
const TermsAndConditions = () => {
  const canonicalUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/terms-and-conditions`;
  return (
    <>
      <NextSeo
        ...
        <section className="section-pad">
          <div className="small-container">
            <div className="elementor-widget-container">
              <h2 className="text-32 mb-10">
                <strong>Website Terms of Use Version 1.4</strong>
              </h2>
              <p>
                The marioxsoftware.com website located at marioxsoftware.com is a
                copyrighted work belonging to Mariox Software Pvt. Ltd. Certain
              ...
              <p>
                ...
                by reference into these Terms. These Terms of Use describe the
              ...
              <p>
                and you represent that you have the authority and capacity to
                enter into these Terms. YOU SHOULD BE AT LEAST 18 YEARS OF AGE TO
                ACCESS THE SITE. IF YOU DISAGREE WITH ALL OF THE PROVISIONS OF
              ...
              <h3 className="text-32 mb-6 mt-10 font-semibold">
                Access to the Site
              </h3>
              <p>
              ...
              <p>
                ...
                in order to build a similar or competitive website; and (d) except
              ...
              <p>
                ...
                for third parties. Such Third-Party Links &amp; Ads are not under
                the control of the Company, and Company is not responsible for any
                Third-Party Links &amp; Ads. The company provides access to these
              ...
              <p>
                to Third-Party Links &amp; Ads. You use all Third-Party Links
              ...
              <p>
                ...
                of its own User Content. Because we do not control User Content,
              ...
              <h3 className="text-32 mb-6 mt-10 font-semibold">Disclaimers</h3>
              <p>
                ...
                make not guarantee that the site will meet your requirements, will
              ...
              <p>
                ...
                of the site is at your own discretion and risk, and you will be
              ...
              <p>
                ...
                the deletion of the User Content associated with your Account from
                our live databases. Company will not have any liability whatsoever
                to you for any termination of your rights under these Terms. Even
              ...
              <p>
                ...
                Site, unlawfully infringing the copyright(s) in work and wish to
              ...
              <h3 className="text-32 mb-6 mt-10 font-semibold">General</h3>
              <p>
              ...
              <p>
                ...
                contract with the Company and affects your rights. It contains
              ...
              <p>
                ...
                Company should be sent to 202, Tower 4, Assotech Business
                Cresterra, Sector 135, Noida. After the Notice is received, you
                and the Company may attempt to resolve the claim or dispute
              ...
              <p>
                Arbitration Rules. The arbitration shall be initiated through the
                ...
                shall agree to select an alternative ADR Provider. The rules of
                the ADR Provider shall govern all aspects of the arbitration
              ...
              <p>
                ...
                shall have the authority to grant motions dispositive of all or
                part of any claim. The arbitrator shall have the authority to
              ...
              <p>
                ...
                TRIAL IN FRONT OF A JUDGE OR A
              </p>
              <p>
                ...
                and less expensive than rules applicable in a court and are
              ...
              <p>
                ...
                order to maintain the status quo pending arbitration. A request
                for interim measures shall not be deemed a waiver of any other
              ...
              <p>
                ...
                to this Arbitration Agreement. In any circumstances where the
                ...
                jurisdiction of the courts located within in County, California,
                for such purposes.
              </p>
              <p>
              ...
              <p>
                The company is located at the address in Section 10.8. If you are
              ...
              <p>
                ...
                consent to receive communications from the Company in an
                ...
                obligation that such communications would satisfy if it were in a
                hard copy writing.
              </p>
              <p>
                ...
                extent permitted by law. Your relationship with the Company is
              ...
              <p>
                ...
                our property or the property of other third parties. You
              </p>
              <p>
              ...
              <p>
                Address: 202, Tower 4, Assotech Business Cresterra, Sector 135,
                Noida&nbsp;
              </p>
              <p>
                Email:{' '}
                <a href="mailto:akash@marioxsoftware.co">
                  akash@marioxsoftware.co
                </a>
              </p>{' '}
            </div>
          </div>
